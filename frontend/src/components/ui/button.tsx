// Generated by shadcn, then edited: the base class used to force every child
// <svg> to 16px unless it carried a `size-*` class. This project sizes its
// icons with `h-4 w-4` / `h-5 w-5` at the call site, so that rule was
// silently shrinking the larger ones. Removed here and from the size variants.
