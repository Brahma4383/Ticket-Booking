/**
 * The Indian Railways station code index - the same 709 rows the `master_train`
 * table in schema.sql is seeded with, so the "From station" / "To station"
 * dropdowns offer every station the database knows about.
 *
 * Kept out of constants/index.ts because of its size; re-exported from there.
 */
...
export const TRAIN_STATIONS: MasterStation[] = [
